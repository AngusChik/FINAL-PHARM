# Generated by Django 5.2.4 on 2026-08-17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0058_inventory_automation_and_audits'),
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ('checkout_unfulfilled', 'Unfulfilled Sale (Stockout)'),
        ...
        migrations.CreateModel(
            name='TransactionCorrectionUndo',
            fields=[
                (
                    'id',
                    models.BigAutoField(
                ...
                (
                    'reason',
                    models.CharField(
                        default='Void entered by mistake', max_length=255,
                    ),
                ),
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name='undo', to='app.transactioncorrection',
                    ),
                ),
                (
                    'created_by',
                    models.ForeignKey(
                        ...
                        related_name='transaction_correction_undos',
